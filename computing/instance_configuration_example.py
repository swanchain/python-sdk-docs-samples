...
def display_config_info(instance_config: dict):
    ...
    Status: If any instances under the instance type is avaliable. Used to find avaliable instances.
    ...
    print(f'\x1b[0;30;43mstatus (If any instances are avaliable):\x1b[0m {instance_config['status']}')
